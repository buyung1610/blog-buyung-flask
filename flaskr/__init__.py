...
# mengatur URI (universal resource identifier) dan apa yang di tampilkan jika URI tersebut diakses
@app.route('/')# ketika alamat http://127.0.0.1:5000/ dipanggil, maka server mengeksekusi fingsi hello()
